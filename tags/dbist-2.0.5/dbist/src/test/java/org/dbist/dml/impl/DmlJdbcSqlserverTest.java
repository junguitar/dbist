...
@ContextConfiguration(locations = { "classpath:WEB-INF/beans.xml", "classpath:WEB-INF/beans-sqlserver.xml" })
public class DmlJdbcSqlserverTest extends AbstractDmlTest {
	@Override
	public Dml getDml() {
